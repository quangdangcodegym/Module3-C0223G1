    ...
    <div class="container-fluid">
      <ul class="list-unstyled topnav-menu float-right mb-0">
        ...
        <li class="dropdown d-none d-lg-block">
          <a class="nav-link dropdown-toggle mr-0" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
            <img src="/dashboard/assets\images\flags\us.jpg" alt="user-image" class="mr-2" height="12"> <span class="align-middle">English <i class="mdi mdi-chevron-down"></i> </span>
          </a>
          <div class="dropdown-menu dropdown-menu-right">
            <!-- item-->
            <a href="javascript:void(0);" class="dropdown-item notify-item">
              <img src="/dashboard/assets\images\flags\germany.jpg" alt="user-image" class="mr-2" height="12"> <span class="align-middle">German</span>
            </a>

            <!-- item-->
            <a href="javascript:void(0);" class="dropdown-item notify-item">
              <img src="/dashboard/assets\images\flags\italy.jpg" alt="user-image" class="mr-2" height="12"> <span class="align-middle">Italian</span>
            </a>

            <!-- item-->
            <a href="javascript:void(0);" class="dropdown-item notify-item">
              <img src="/dashboard/assets\images\flags\spain.jpg" alt="user-image" class="mr-2" height="12"> <span class="align-middle">Spanish</span>
            </a>

            <!-- item-->
            <a href="javascript:void(0);" class="dropdown-item notify-item">
              <img src="/dashboard/assets\images\flags\russia.jpg" alt="user-image" class="mr-2" height="12"> <span class="align-middle">Russian</span>
            </a>
          </div>
        </li>
              ...
              <div class="inbox-widget">
                <a href="#">
                  <div class="inbox-item">
                    <div class="inbox-item-img"><img src="/dashboard/assets\images\users\avatar-1.jpg" class="rounded-circle" alt=""></div>
                ...
                <a href="#">
                  <div class="inbox-item">
                    <div class="inbox-item-img"><img src="/dashboard/assets\images\users\avatar-2.jpg" class="rounded-circle" alt=""></div>
                ...
                <a href="#">
                  <div class="inbox-item">
                    <div class="inbox-item-img"><img src="/dashboard/assets\images\users\avatar-3.jpg" class="rounded-circle" alt=""></div>
                ...
                <a href="#">
                  <div class="inbox-item">
                    <div class="inbox-item-img"><img src="/dashboard/assets\images\users\avatar-4.jpg" class="rounded-circle" alt=""></div>
                ...
                <a href="#">
                  <div class="inbox-item">
                    <div class="inbox-item-img"><img src="/dashboard/assets\images\users\avatar-5.jpg" class="rounded-circle" alt=""></div>
      ...
      <div class="logo-box">
        <a href="index.html" class="logo text-center">
                                    <span class="logo-lg">
                                        <img src="/dashboard/assets\images\logo.png" alt="" height="30">
