...
public class CustomerServlet extends HttpServlet {
    ...
    private void showCustomers(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher(Config.URL_VIEW_ADMIN + "customer/list.jsp").forward(req, resp);
    ...
    private void showFormCreate(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("customerTypes", customerTypes);
        RequestDispatcher requestDispatcher = req.getRequestDispatcher(Config.URL_VIEW_ADMIN + "customer/create.jsp");
